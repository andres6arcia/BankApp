...
import { RoleIdValueObject } from './role-id.value-object';

describe('RoleIdValueObject', () => {
  let objectValue: RoleIdValueObject;

  beforeEach(() => {
    // Arrange and Act
    objectValue = new RoleIdValueObject();
  });
  ...
  describe('Validations', () => {
    it('should give an invalid UUIDv4 format error', () => {
      ...
      // Act
      objectValue = new RoleIdValueObject(id);
